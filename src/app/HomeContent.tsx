...
export default function HomeContent({ settings }: { settings: Record<string, string> }) {
  return (
            ...
            <div>
              ...
              >
                <span className="text-xs tracking-[0.3em] uppercase text-gold font-sans font-medium">
                  {settings.homeHeroTagline || "Finance · Strategy · Leadership · Purpose"}
                </span>
              </motion.div>
              ...
              >
                {settings.homeHeroName || "Pramesh"}
                <br />
                <span className="text-gold">{settings.homeHeroLastName || "Bhandari"}</span>
              </motion.h1>
              ...
              >
                ...
                <p className="text-charcoal-light/70 text-lg leading-relaxed max-w-lg font-light">
                  {settings.homeHeroDescription || "A young finance professional, future entrepreneur, and research-oriented thinker from Eastern Nepal — driven by discipline, strategy, and the pursuit of meaningful impact in business and healthcare."}
                </p>
              </motion.div>
            ...
            >
              <div className="relative">
                <div className="w-[400px] h-[500px] relative overflow-hidden border border-beige/50">
                  <img
                    src={settings.homeProfilePhoto || "/profile.jpg"}
